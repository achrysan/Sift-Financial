...
//extra comment for regrading
   ...
   while (getline(inputFile, lineFromFile))
   {
      ...
      cout<<pEmployee->name_<<endl;
      cout<<pEmployee->status_<<endl;
      cout<<pEmployee->salary_<<endl;
      cout<<pEmployee->payBasis_<<endl;
      cout<<pEmployee->positionTitle_<<endl;
   }
